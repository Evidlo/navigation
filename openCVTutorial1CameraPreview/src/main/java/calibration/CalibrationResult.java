...
public abstract class CalibrationResult {
    ...
    public static void save(Activity activity, Mat cameraMatrix, Mat distortionCoefficients) {
        ...
        File myFile = new File(Environment.getExternalStorageDirectory().toString() + CameraCalibrationActivity.DATA_FILEPATH);
        try
        {
        ...
        Intent intent = new Intent(activity, MarkerTracker.class);
